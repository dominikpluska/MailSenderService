...
namespace MailSenderService.MailSender
{
    public class MailSenderImplementation : IMailSender
    {
        ...
        public MailSenderImplementation(string senderMailAddress, string host, int port = 25)
        {
        ...
        public MailSenderImplementation(string senderMailAddress, string host, bool enableSsl, bool useDefaultCredentials, int port, string password = null)
        {
            _senderMailAddress = senderMailAddress;
            _host = host;
            _port = port;
        ...
        public void SendMail(string recipientMailAddress, string subject, string body, string[] attachmentPaths = null)
        {
